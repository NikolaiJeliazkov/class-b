...
class BootActiveForm extends CActiveForm
{
	...
	* @return string the generated row
	*/
	public function textAutoCompleteRow($model, $attribute, $htmlOptions = array(), $autocompleteOptions = array())
	{
		return $this->inputRow(BootInput::TYPE_TEXT_AUTOCOMPLETE, $model, $attribute, $autocompleteOptions, $htmlOptions);
	}
	 ...
	 * @return string the generated row
	 */
	public function textCKEditor($model, $attribute, $htmlOptions = array(), $editorOptions)
	{
		return $this->inputRow(BootInput::TYPE_TEXTCKEDITOR, $model, $attribute, $editorOptions, $htmlOptions);
	}
