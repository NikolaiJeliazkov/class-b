...
insert  into `users`(`userId`,`userStatus`,`userType`,`userName`,`userPass`,`studentId`,`userEmail`,`userPhones`,`userIsVisible`,`notes`,`userFullName`) values (1,1,100,'root','d8578edf8458ce06fbc5bb76a58c5ca4',NULL,'njeliazkov@gmail.com','',0,'',''),(2,1,3,'ka_tya@abv.bg','e10adc3949ba59abbe56e057f20f883e',NULL,'ka_tya@abv.bg','',1,'','Катя Дечева');
