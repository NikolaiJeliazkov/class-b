...
abstract class BootInput extends CInputWidget
{
	...
	const TYPE_TEXT_AUTOCOMPLETE = 'autocomplete';
	const TYPE_TEXTCKEDITOR = 'textckeditor';
	...
	public function run()
	{
		switch ($this->type)
		{
			...
			case self::TYPE_TEXT_AUTOCOMPLETE:
				$this->textAutoComplete();
				break;

			case self::TYPE_TEXTCKEDITOR:
				$this->textCKEditor();
				break;
	...
	abstract protected function textAutoComplete();
	abstract protected function textCKEditor();
