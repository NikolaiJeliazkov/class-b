...
// 		array('name'=>'messageId','header'=>$model->getAttributeLabel('messageId')),
		...
		array('value'=> '($data[\'fromVisible\']) ? $data[\'messageFrom\'] : (($data[\'fromUserType\']==3)?"класен ръководител":"родител")', 'name'=>'messageFrom','header'=>$model->getAttributeLabel('messageFrom'), 'visible'=>($model->getScenario()=='inbox')),
		array('name'=>'messageFromStudent','header'=>$model->getAttributeLabel('messageFromStudent'), 'visible'=>($model->getScenario()=='inbox')),
		array('value'=> '($data[\'toVisible\']) ? $data[\'messageTo\'] : (($data[\'toUserType\']==3)?"класен ръководител":"родител")', 'name'=>'messageTo','header'=>$model->getAttributeLabel('messageTo'), 'visible'=>($model->getScenario()=='outbox')),
